...
class StatsCalculator
  ...
  # @example
  #   calculator = StatsCalculator.new(base_values: { str_mod: 10 }, life_form: { attribute_mods: { str_mod: 2 } }, equipment_manager: { attribute_mods: { str_mod: 3 } })
  ...
  # @example
  #   calculator = StatsCalculator.new(base_values: { basic_mod: 10 }, life_form: { effort_mods: { basic_mod: 2 } }, equipment_manager: { effort_mods: { basic_mod: 3 } })
